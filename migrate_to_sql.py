...
def extract_playlist_id(channel_name_to_find):
    ...
    for result in finding:
        ...
        playlist_info = {
            ...
            #'playlist_name': playlist_dict['playlist_name'],
        }
...
def create_playlist_df_table(channel_name_to_find):
   ...
   # playlist_df['playlist_name'] = playlist_df['playlist_name'].astype(str)
...
def create_video_df_table(channel_name_to_find):
    ...
    video_df['dislike_count'] = video_df['like_count'].astype(int)
...
def create_comment_df_table(channel_name_to_find):
    ...
    comment_df['channel_name'] = channel_name_to_find
