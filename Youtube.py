...
#page congiguration
st.set_page_config(page_title= "Youtube Channels Data Analysis",
                   page_icon= ":yt:",
                   layout= "wide",)
...
def app_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://cutewallpaper.org/21/background/Geometric-Background-Sketch-freebie-Download-free-resource-.png");   
...
with navigation:
    ...
    selected = option_menu('Main Menu', ['HOME',"YOUTUBE CHANNEL QUERY","DATABASE MIGRATION","CHANNEL ENQUIRY"],
...
with data:
    if selected=='HOME':
        ...
        st.markdown("##### ***This application involves getting channel_Id from user as a input to fetch channel data like title,id,subscription,likes,dislikes.. from YouTube using the YouTube API . Storing the collected data in MongoDB, migrating from NoSQL database to SQL, searching and retreiving data from the SQL database. ***")
